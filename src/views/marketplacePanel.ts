...
<body>
  ...
  <script nonce="${nonce}">
    ...
    var svgOpenClaw = '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M12 13v6"/><path d="M9 11a3 3 0 01-3-3 3 3 0 00-3-3"/><path d="M15 11a3 3 0 003-3 3 3 0 013-3"/><path d="M9 11c0 1.5 1.3 2.5 3 2.5s3-1 3-2.5"/><path d="M12 19c-1.5 0-3 .8-3 2"/><path d="M12 19c1.5 0 3 .8 3 2"/></svg>';
    ...
    function getSourceIcon(sourceId) {
      ...
      if (id.indexOf('openclaw') !== -1) return svgOpenClaw;
